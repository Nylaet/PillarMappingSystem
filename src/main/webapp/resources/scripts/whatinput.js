(function (a, b) {
    typeof define === "function" && define.amd ? define([], function () {
        ...
        (this, function () {
            ...
            function c(a) {
                var c = a.keyCode ? a.keyCode : a.which, b = a.target || a.srcElement, d = l[a.type];
                ...
                if (h !== d && (i || !h || !(d === "keyboard" && o[c] !== "tab" && j.indexOf(b.nodeName.toLowerCase()) >=
                        0)))
                    h = d, f.setAttribute("data-whatinput", h), n.indexOf(h) === -1 && n.push(h);
            ...
            var g = [], f = document.body, k = !1, h = null, j = ["input", "select", "textarea"], i = f.hasAttribute("data-whatinput-formtyping"), l = {keydown: "keyboard", mousedown: "mouse", mouseenter: "mouse", touchstart: "touch", pointerdown: "pointer", MSPointerDown: "pointer"}, n = [], o = {9: "tab", 13: "enter", 16: "shift", 27: "esc", 32: "space",
                37: "left", 38: "up", 39: "right", 40: "down"}, q = {2: "touch", 3: "touch", 4: "mouse"}, p;
            (function () {
                var c = "mousedown";
