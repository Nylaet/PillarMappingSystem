...
(function (a, b) {
    function c() {}
    var d = {
        version: 0.1, inherit: function (a, c) {
            var b = function () {};
            ...
            if (c.pointerId && !b.hasPointerCapture)
                if (a.setPointerCapture)
                    a.setPointerCapture(c.pointerId), b.hasPointerCapture =
                            !0;
                else if (a.msSetPointerCapture)
                    a.msSetPointerCapture(c.pointerId), b.hasPointerCapture = !0
    ...
    a.extend(c.prototype, {bind: function (c, b, d) {
...
(function (a, b) {
    ...
    a.extend(b.ImageLoader.prototype, {defaultOptions: {timeoutInterval: 1E3},
        add: function (d, g) {
            if (d) {
                urls = b.ensureArray(d);
                for (var f = 0; f < urls.length; f++) {
                    var j = a.extend({reqId: c++, src: urls[f], width: 0, height: 0, priority: 50, callback: null, data: null}, g);
                    this._queue.push(j);
                    this._needsSort = !0;
            ...
            if (!(this._currentEntry && this._currentEntry.src == a)) {
                ...
                if (b != 0 && b < this._queue.length)
                    this._queue = this._queue.splice(b,
                            c ? this._queue.length - b : 1).concat(this._queue)
            }
        }, start: function () {
            if (!this._isRunning)
                this._isRunning = !0, this._loadNext(), this.trigger("wp-image-loader-start")
        }, stop: function () {
            if (this._isRunning)
                this._currentEntry && this._queue.unshift(this._currentEntry), this._resetLoader(), this._isRunning = !1, this.trigger("wp-image-loader-stop")
        }, clearQueue: function () {
            ...
            if (this._timeoutTimerId)
                clearTimeout(this._timeoutTimerId), this._timeoutTimerId = 0
        }, _handleLoad: function () {
            var a =
                    this._loader, c = this._currentEntry;
            c.width = a.width;
            c.height = a.height;
...
(function (a, b) {
    ...
    a.extend(c.prototype, {defaultOptions: {}, _widgetName: "Widget", _initialize: function () {
            var c;
            this.plugins = [];
            ...
            if (1 == f.length)
                this.$bp = f, this.breakpoint = this.$bp.data("bpObj");
            return b
        }, _initializePlugins: function (a) {
            for (var a = a || {}, c = ((typeof a.useDefaultPlugins === "undefined" || a.useDefaultPlugins) && this.defaultPlugins ? this.defaultPlugins : []).concat(a.plugins ||
    ...
    b.widget = function (c, g, f) {
        var j = f && g || b.Widget, f = f || g || {}, g = function () {
...
(function (a, b) {
    b.widget("Widget.Button", b.Widget, {defaultOptions: {hoverClass: "wp-button-hover", activeClass: "wp-button-down", disabledClass: "wp-button-disabled", disabled: !1, clickCallback: null, prevCallback: null, nextCallback: null}, _attachBehavior: function () {
            var c = this, b = function (g) {
            ...
            this.$element.on("keydown",
                ...
                if (!c.options.disabled)
                    c.mouseDown = !0, c.$element.addClass(c.options.activeClass), a(c.$element).on("mouseup pointerup", b)
            });
            this.disabled(this.options.disabled)
        }, disabled: function (a) {
            if (typeof a === "boolean")
                this.options.disabled = a, this.$element[a ? "addClass" : "removeClass"](this.options.disabledClass);
...
(function (a, b) {
    b.widget("Widget.RadioGroup", b.Widget, {_widgetName: "radio-group", defaultOptions: {defaultIndex: 0, hoverClass: "wp-radio-hover", downClass: "wp-radio-down", disabledClass: "wp-radio-disabled", checkedClass: "wp-radio-checked", disabled: !1, toggleStateEnabled: !1}, _attachBehavior: function () {
            var a = this;
            this.buttons = [];
            ...
            var d = this, g = new b.Widget.Button(a, {hoverClass: this.options.hoverClass, downClass: this.options.downClass, disabledClass: this.options.disabledClass, clickCallback: function (b) {
            ...
            var c = this._getElement(c), b = this.activeElement, g = this.options.checkedClass;
            ...
            if (typeof c === "boolean")
                this.disabled = c, a.each(this.buttons, function () {
                    this.disabled(c)
                });
            return this.options.disabled
        }});
...
(function (a, b) {
    b.widget("Widget.TabGroup", b.Widget.RadioGroup, {defaultOptions: {defaultIndex: 0, hoverClass: "wp-tab-hover", downClass: "wp-tab-down", disabledClass: "wp-tab-disabled", checkedClass: "wp-tab-active", disabled: !1, toggleStateEnabled: !1, isPopupButtonWidget: !1, parentSelectors: [".ThumbGroup", ".AccordionWidget", ".TabbedPanelsWidget"]}, _attachBehavior: function () {
            ...
            if (this.options.isPopupButtonWidget === !0 || this.numButtons === 1)
                ...
                this.parentElement = this.buttons[0].$element.parents(this.options.parentSelectors.join()), this.parentElement.attr("role",
                        "tablist"), a.each(this.buttons, function (a) {
                    this.$element.attr({role: "tab", tabindex: "0"});
                    a > 0 && c.uncheckButton(this.$element)
                })
        }, checkButton: function (c) {
            var b = this._getElement(c), g = this._getElementIndex(b), g = {tab: b, tabIndex: g};
            this.trigger("wp-tab-before-select", g);
            this._super.prototype.checkButton.apply(this, arguments);
            a(b).attr({tabindex: "0"});
            this.options.contentLayout_runtime !== "lightbox" && a(b).attr({"aria-selected": "true"});
            this.trigger("wp-tab-select", g)
        }, uncheckButton: function (c) {
            this._super.prototype.uncheckButton.apply(this,
                    arguments);
            this.isPopupButtonWidget || (a(c).attr({tabindex: "-1"}), this.options.contentLayout_runtime !== "lightbox" && a(c).attr({"aria-selected": "false"}))
        }});
...
(function (a, b) {
    b.widget("Widget.PanelGroup", b.Widget, {_widgetName: "panel-group", defaultOptions: {defaultIndex: 0, panelClass: "wp-panel", activeClass: "wp-panel-active", toggleStateEnabled: !1, tabGroups: null}, _setUp: function () {
            var a = this;
            this.tabGroups = [];
        ...
        _getElement: function (a) {
            ...
            a.each(this.$element, function (b, g) {
                a(g).attr({role: "tabpanel", "aria-labelledby": c.buttons[b].$element.attr("id")});
                c.buttons[b].$element.attr({"aria-controls": a(g).attr("id")})
            })
        }, showPanel: function (c) {
            if (!this.showLock) {
                ++this.showLock;
                var b = this._getElement(c), g = this.activeElement, f = this.options.activeClass;
                if (b)
                    if (b !== g) {
                        c = {panel: b, panelIndex: this._getElementIndex(b)};
                        ...
                        for (g = 0; g < b.length; g++)
                            f = b[g], f !== this.tabDriver && f.selectTab(this.activeIndex);
            ...
            if (c = typeof c === "number" ? this.$element.eq(c)[0] : c) {
                var b = {panel: c, panelIndex: this._getElementIndex(c)};
                this.trigger("wp-panel-before-hide", b);
                a(c).removeClass(this.options.activeClass);
                if (c === this.activeElement)
                    this.activeElement = null, this.activeIndex = -1;
                this.trigger("wp-panel-hide", b)
            }
        }, _handleTabSelect: function (a, b) {
            if (!this.showLock)
                this.tabDriver = a.target, this.showPanel(b.tabIndex), this.tabDriver = null
...
(function (a, b) {
    b.widget("Widget.Disclosure", b.Widget, {defaultOptions: {widgetClassName: "wp-disclosure-panels", tabClassName: "wp-disclosure-panels-tab", tabHoverClassName: "wp-disclosure-panels-tab-hover", tabDownClassName: "wp-disclosure-panels-tab-down", panelClassName: "wp-disclosure-panels-panel", tabActiveClassName: "wp-disclosure-panels-tab-active", panelActiveClassName: "wp-disclosure-panels-panel-active", defaultIndex: 0, toggleStateEnabled: !1}, _attachBehavior: function () {
            var a = this.$element[0], d = this.options.widgetClassName,
                    g = b.scopedFind(a, "." + this.options.tabClassName, d, a), a = b.scopedFind(a, "." + this.options.panelClassName, d, a);
            this.tabs = new b.Widget.TabGroup(g, {hoverClass: this.options.tabHoverClassName, downClass: this.options.tabDownClassName, checkedClass: this.options.tabActiveClassName, toggleStateEnabled: this.options.toggleStateEnabled});
            this.panels = new b.Widget.PanelGroup(a, {panelClass: this.options.panelClassName, activeClass: this.options.panelActiveClassName, defaultIndex: this.options.defaultIndex, toggleStateEnabled: this.options.toggleStateEnabled});
            this.panels.addTabGroup(this.tabs)
        }});
    b.widget("Widget.TabbedPanels", b.Widget.Disclosure, {defaultOptions: {widgetClassName: "wp-tabbed-panels-panels", tabClassName: "wp-tabbed-panels-panels-tab", tabHoverClassName: "wp-tabbed-panels-panels-tab-hover", tabDownClassName: "wp-tabbed-panels-panels-tab-down", tabActiveClassName: "wp-tabbed-panels-panels-tab-active", panelClassName: "wp-tabbed-panels-panels-panel", panelActiveClassName: "wp-tabbed-panels-panels-panel-active", toggleStateEnabled: !1}});
    b.widget("Widget.Accordion",
            b.Widget.Disclosure, {defaultOptions: {widgetClassName: "wp-accordion", tabClassName: "wp-accordion-tab", tabHoverClassName: "wp-accordion-tab-hover", tabDownClassName: "wp-accordion-tab-down", tabActiveClassName: "wp-accordion-tab-active", panelClassName: "wp-accordion-panel", panelActiveClassName: "wp-accordion-panel-active", toggleStateEnabled: !1}})
})(jQuery, WebPro, window, document);
(function (a, b) {
    b.Widget.Disclosure.DisplayPropertyTransitionPlugin = {defaultOptions: {}, initialize: function (c, b) {
            var g = this;
            ...
            var a = a.panels, b = a.$element, g = a.activeIndex;
    ...
    b.Widget.Disclosure.AccordionTransitionPlugin =
            {defaultOptions: {transitionDirection: "vertical", transitionDuration: 500, dispatchTransitionEvents: !0}, initialize: function (b, d) {
                    var g = this;
                    ...
                    if (-1 != a.panels.activeIndex) {
                        var b = a.options, g = b.tabActiveClassName, b = b.transitionDirection, f = a.panels.activeIndex, a = a.panels.$element,
                                j = {overflow: "hidden"};
                    ...
                    var d = b.options, g = d.tabActiveClassName, f = d.transitionDirection;
                    b.panels.$element.each(function () {
                        var b = {overflow: "hidden"};
                    ...
                    var d = this, g = b.panels, f = g.$element, j = g.activeIndex, h = b.options.transitionDirection,
                            i = b.options.widgetClassName === "AccordionWidget" ? a(f[0]).closest("*[data-rotate]") : null;
                    if (i && i.length > 0)
                        b.options.marginBottom = Muse.Utils.getCSSIntValue(i, "margin-bottom"), b.options.originalHeight = i[0].scrollHeight;
                    ...
                    if ((b = g.options.rotatedAccordion) && b.length > 0) {
                        if (g.options.originalHeight == 0 && "undefined" !== typeof d)
                            g.options.marginBottom = Muse.Utils.getCSSIntValue(b, "margin-bottom"), g.options.originalHeight =
                            b[0].scrollHeight;
                        this._updateMarginBottomForRotatedAccordion(g)
                    }
                }, _showPanel: function (b, d) {
                    if (!b.$bp || b.$bp.hasClass("active")) {
                        var g = b.options, f = g.transitionDirection, j = a(d.panel), h = {}, i = g.dispatchTransitionEvents, k = this, l = j.height(), m = function (a) {
                        ...
                        j.stop(!0, !0).queue("animationFrameFx", a.animationFrameFx).animate(h,
                                {duration: g.transitionDuration, progress: i ? m : null, queue: "animationFrameFx", complete: function () {
                                        var a = {overflow: ""};
                                        if (f === "vertical" || f === "both")
                                            a.height = "auto";
                                        if (f === "horizontal" || f === "both")
                    ...
                    if (!b.$bp || b.$bp.hasClass("active")) {
                        var g = b.options, f = g.transitionDirection, j = a(d.panel), h = {}, i = g.dispatchTransitionEvents, k = this, l = j.height(),
                                m = function (a) {
                                    a = parseInt(a.elem.style.height);
                                    k._transitionPanel(l, a, b);
                                    l = a
                        ...
                        if (f === "horizontal" || f === "both")
                            h.width = "0";
                        j.stop(!0, !0).queue("animationFrameFx", a.animationFrameFx).animate(h, {duration: g.transitionDuration, queue: "animationFrameFx", progress: i ? m : null, complete: function () {
        ...
        document);
(function (a, b) {
    b.widget("Widget.SlideShowBase", b.Widget, {_widgetName: "slideshow-base", defaultOptions: {displayInterval: 6E3, autoPlay: !1, loop: !0, playOnce: !1}, _setUp: function () {
            var a = this;
            this._ssTimer = 0;
            ...
            return this._executeCall("close",
                    arguments)
        }, _first: function () {}, _last: function () {}, _previous: function () {}, _next: function () {}, _goTo: function () {}, _close: function () {}})
})(jQuery, WebPro, window, document);
(function (a, b) {
    b.widget("Widget.ContentSlideShow", b.Widget.SlideShowBase, {_widgetName: "content-slideshow", defaultOptions: {slideshowClassName: "wp-slideshow", clipClassName: "wp-slideshow-clip", viewClassName: "wp-slideshow-view", slideClassName: "wp-slideshow-slide", slideLinkClassName: "wp-slideshow-slide-link", firstBtnClassName: "wp-slideshow-first-btn", lastBtnClassName: "wp-slideshow-last-btn", prevBtnClassName: "wp-slideshow-prev-btn", nextBtnClassName: "wp-slideshow-next-btn", playBtnClassName: "wp-slideshow-play-btn",
            stopBtnClassName: "wp-slideshow-stop-btn", closeBtnClassName: "wp-slideshow-close-btn", playingClassName: "wp-slideshow-playing"}, _findWidgetElements: function (a) {
            var d = this.$element[0];
            return b.scopedFind(d, a, this.options.slideshowClassName, d)
        }, _attachBtnHandler: function (a, b) {
            var g = this;
            this["$" + b + "Btn"] = this._findWidgetElements("." + a).attr({tabindex: "0", role: "button", "aria-label": b}).unbind("keydown").bind("keydown", function (a) {
            ...
            var g = this.slides ? this.slides.$element : this._findWidgetElements("." + d.slideClassName), f = this.tabs ? this.tabs.$element : this._findWidgetElements("." +
                    d.slideLinkClassName), j = d.event === "click" && d.deactivationEvent === "mouseout_click";
            if (!this.slides && (this.slides = new b.Widget.PanelGroup(g, {defaultIndex: this.slides && this.slides.activeIndex || d.defaultIndex || 0, toggleStateEnabled: j}), this.slides.bind("wp-panel-show", this._panelShowCallback), this.tabs = null, f.length))
                this.tabs = new b.Widget.TabGroup(f, {defaultIndex: this.tabs && this.tabs.activeIndex || d.defaultIndex || 0, toggleStateEnabled: j, contentLayout_runtime: d.contentLayout_runtime}), this.slides.addTabGroup(this.tabs);
            ...
            var a = this.slides, b = a.$element.length, g = a.activeIndex, b = (g < 1 ? b : g) - 1;
            !this.options.loop && 0 == g ? this.isPlaying() && this.stop() : a.showPanel(b)
        }, _next: function () {
            var a = this.slides, b = a.activeIndex, g = (b + 1) % a.$element.length;
            ...
            if (this._csspIsImageSlideShow && (b = a(this.slides.$element[b]), b = b.is("img") ? b : b.find("img"), b.length > 0 && (b.hasClass(this.options.imageIncludeClassName) || !b[0].complete)))
                return!1;
            return!0
        }})
})(jQuery, WebPro, window, document);
(function (a, b, c, d, g) {
    b.Widget.ContentSlideShow.fadingTransitionPlugin = {defaultOptions: {transitionDuration: 500}, initialize: function (b, c) {
            var d = this;
            ...
            var j = this, h = f.slides, i = h.$element, k = h.activeIndex, l = f._findWidgetElements("." + f.options.viewClassName);
            ...
            if (f.options.elastic === "fullWidth") {
                var o = a(c), r = a(d.body), p = function (b) {
            ...
            if (Muse.Browser.Features.Touch && f.options.enableSwipe === !0) {
                ...
                i.each(function () {
                    ...
                    var d = Muse.Utils.getCanvasDirection(c, "horizontal"), g = d.dir === "horizontal", h = d.reverse;
                    if (d = c.swipe.defaults.excludedElements) {
                        var d = d.split(/\s*,\s*/), k = d.indexOf("a");
                        if (0 <= k)
                            d.splice(k, 1), c.swipe.defaults.excludedElements = d.join(", ")
                    }
                    c.swipe({triggerOnTouchEnd: !0, allowPageScroll: g ? "vertical" : "horizontal", threshold: 75, swipeStatus: function (a, d, k, o) {
                            if (d == "start")
                                f.stop();
                            else if (d == "move" && (g && (k == "left" ||
                                    k == "right") || !g && (k == "up" || k == "down")))
                                !b.hasPointerCapture() && Math.abs(o) > 1 && b.setPointerCapture(c[0], a), j._scrollTo(f, -1, o * (!h && (k == "left" || k == "up") || h && (k == "right" || k == "down") ? 1 : -1), 0);
                            else if (d == "cancel")
                                j._scrollTo(f, f.slides.activeIndex, 0, t), b.releasePointerCapture(c[0], a), f.trigger("wp-swiped");
                            else if (d == "end") {
            ...
            if (!b._ftpSwipeNoInterrupt) {
                var k = b.slides.$element, l = b.slides.activeIndex, m = c == -1;
                c == -1 && (c = d < 0 ? l - 1 < 0 ? k.length - 1 : l - 1 : l + 1 > k.length - 1 ? 0 : l + 1);
                var o = a(k[l]), r = a(k[c]);
                if (!m && d == 0 || l == c) {
                    b._ftpSwipeNoInterrupt = !0;
                    var p = 0, n = !1, t = function () {
                        if (!n && (n = !0, r.show().css("opacity", ""), c != l && b.slides.showPanel(c), ++p == k.length))
                            b._ftpSwipeNoInterrupt = !1
                    };
                    if (r.css("opacity") != r.data("opacity")) {
                        var q = setTimeout(t, g + 10);
                        r.stop(!1, !0).animate({opacity: r.data("opacity")},
                                g, function () {
                                    clearTimeout(q);
                                    t()
                                })
                    ...
                    k.each(function (d) {
                        var h = a(this), o = !1, l = function () {
                            if (!o && (o = !0, h.hide().css("opacity", ""), ++p == k.length))
                                b._ftpSwipeNoInterrupt = !1
                        }, n;
                        d != c && (h.css("display") != "none" && h.css("opacity") != 0 ? (n = setTimeout(l, g + 10), h.stop(!1, !0).animate({opacity: 0}, g, function () {
                            clearTimeout(n);
                            l()
                        })) : l())
                    })
                } else
                    d = Math.abs(d), m = o.width(), d > m && (d = m), d = r.data("opacity") * (d / m), m = o.data("opacity") * (1 - d), o.stop(!1, !0).animate({opacity: m}, g), r.stop(!1, !0).show().animate({opacity: d},
                            g)
            }
        }};
    b.Widget.ContentSlideShow.filmstripTransitionPlugin = {defaultOptions: {transitionDuration: 500, transitionStyle: "horizontal"}, initialize: function (b, c) {
            var d = this;
            a.extend(c, a.extend({}, d.defaultOptions, c));
            b.bind("attach-behavior", function () {
                d.attachBehavior(b)
            ...
            var j = this, h = a(c), i = a(d.body), k = f.options, l = function () {
                return k.elastic === "fullWidth" ? Math.max(h.width(), parseInt(i.css("min-width"))) : p.width()
            }, m = k.transitionStyle === "horizontal", o = f.slides, r = o.$element, p = f._findWidgetElements("." + k.clipClassName), n = f._findWidgetElements("." + k.viewClassName), t = l(), q = p.height(), y = {left: 1, right: 1}, C = {up: 1,
                down: 1}, w = {top: "0", left: "0"}, v = p.css("position");
            ...
            f.options.contentLayout_runtime ===
                    "stack" && f.bind("wp-slideshow-close", function () {
                        p.css({opacity: 0.99}).stop(!0).animate({opacity: 0}, {queue: !1, duration: k.transitionDuration, complete: function () {
            ...
            if (k.elastic !== "off")
                ...
                w[m ? "width" : "height"] = v + "px", w[m ? "height" : "width"] = (m ? q : t) + "px";
            ...
            Muse.Browser.Features.Touch && f.options.enableSwipe === !0 && (a(this), m ? n.addClass("horizontalSlideShow") : n.addClass("verticalSlideShow"), n.swipe({triggerOnTouchEnd: !0, allowPageScroll: m ? "vertical" : "horizontal", threshold: 75, swipeStatus: function (a, c, d, g) {
                    var h = Muse.Utils.getCanvasDirection(n, k.transitionStyle).reverse, h = !h && (d == "left" || d == "up") || h && (d == "right" || d == "down") ? 1 : -1;
                    switch (c) {
                        case "start":
                            f.stop();
                            break;
                        case "move":
                            if (m && d in y || !m && d in C)
                                !b.hasPointerCapture() && Math.abs(g) > 1 && b.setPointerCapture(n[0],
                                        a), j._scrollBy(f, g * h);
                            break;
                        case "cancel":
                            j._goToSlide(f, o.activeElement, 0);
            ...
            var c = a._fstp$View, d = a.slides.activeIndex * -a._fstpOffsetSize, g = a._fstpStyleProp, l = {};
            c.stop(!1, !0);
            l[g] = d - b + "px";
            c.css(l)
        }, _finalizeSwipe: function (a, b, c) {
            var d = a.slides, g = a._fstp$View, l = b / a._fstpOffsetSize, b = a._fstpStyleProp,
                    m = {}, l = c === 1 ? Math.ceil(l) : Math.floor(l), l = Math.max(0, Math.min(l, d.$element.length - 1));
            ...
            if (b) {
                var g = a(c), k = b._fstp$View, l = b._fstpStyleProp, m = l === "left" ? "offsetLeft" : "offsetTop", o = l === "left" ? "offsetWidth" : "offsetHeight", r = c ? -c[m] : b._fstp$Clip[0][o], p = {};
                p[l] = r + "px";
                var n = b._fstpRequestType, t = b._fstpOldActiveIndex;
                if (n && t !== -1) {
    ...
    b.Widget.ContentSlideShow.alignPartsToPagePlugin = {defaultOptions: {alignPartToPageClassName: "wp-slideshow-align-part-to-page"}, initialize: function (b, c) {
            var d = this;
            a.extend(c, a.extend({}, d.defaultOptions, c));
            b.bind("attach-behavior", function () {
                d.attachBehavior(b)
        ...
        attachBehavior: function (b) {
            if (!("fullWidth" !== b.options.elastic || !b.$element.hasClass("align_parts_to_page") || "fixed" !== b.$element.css("position") || b.options.contentLayout_runtime === "lightbox")) {
                var d = a(c), g = a("#page"), i = b.options, k = function () {
    ...
    b.Widget.ContentSlideShow.slideImageIncludePlugin = {defaultOptions: {imageIncludeClassName: "wp-slideshow-slide-image-include", slideLoadingClassName: "wp-slideshow-slide-loading"}, initialize: function (c, d) {
            var g = this;
            a.extend(d, a.extend({}, g.defaultOptions, d));
            ...
            for (var b = this, c = a._cssilLoader, d = a._findWidgetElements("." + a.options.slideClassName), g = d.length, l = "." + a.options.imageIncludeClassName,
                ...
                var p = d.eq(a._shuffleArray ? a._shuffleArray[r] : r), n = p.is("img") ? p : p.find(l), t = n[0];
                if (t) {
                    var q = a._getAjaxSrcForImage(n) || t.href;
                    if (q)
                        n = {width: n.data("width"), height: n.data("height"), $ele: n, $slide: p}, t.style.visibility = "hidden", c.add(q, {callback: o, data: n}), p.addClass(m)
                }
            }
    ...
    b.Widget.ContentSlideShow.shufflePlayPlugin = {defaultOptions: {randomDefaultIndex: !0}, initialize: function (b, c) {
            var d = this;
            ...
            if (a && a.length)
                for (var b = a.length; --b; ) {
                    var c = Math.floor(Math.random() * (b + 1)), d = a[c];
                    a[c] = a[b];
                    a[b] = d
                }
        }, _reshuffle: function (a) {
            var b = a._shuffleArray, c = {}, d = a.slides ? a.slides.$element.length :
            ...
            if (a.isPlaying()) {
                var b = a.slides.activeIndex, c = a._shuffleNextDict[b] || 0;
    ...
    b.widget("Widget.Form", b.Widget, {_widgetName: "form", defaultOptions: {validationEvent: "blur", errorStateSensitivity: "low", ajaxSubmit: !0, fieldWrapperClass: "field", formErrorClass: "form-error", formSubmittedClass: "form-submitted", formDeliveredClass: "form-delivered", focusClass: "focus", notEmptyClass: "not-empty", emptyClass: "empty", validClass: "valid", invalidClass: "invalid", requiredClass: "required"}, validationTypes: {"always-valid": /.*/, email: /^[a-z0-9!#$%&'*+\/=?^_`{|}~-]+(?:\.[a-z0-9!#$%&'*+\/=?^_`{|}~-]+)*@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?$/i, alpha: /^[A-z\s]+$/,
            numeric: /^[0-9]+$/, phone: /^([0-9])?(\s)?(\([0-9]{3}\)|[0-9]{3}(\-)?)(\s)?[0-9]{3}(\s|\-)?[0-9]{4}(\s|\sext|\sx)?(\s)?[0-9]*$/, captcha: function (a) {
                ...
                if (b.indexOf(":") != -1 && b.match(/:/).length == 1) {
                    var c = b.split(":"), j = parseInt(c[0]), c = parseInt(c[1]);
                    if (j < 0 || j > 24)
                        return!0;
                    if (c < 0 || c > 59)
                        return!0
            ...
            this.$element.find("." +
                ...
                c.attr("data-type") == "captcha" && (c.data("captchaValid", !1), c.find('input[name="CaptchaV2"]').keyup(function () {
                    var f = a(this).val(), j = c.find('input[name="CaptchaHV2"]').val();
            ...
            this.$element.find("input, textarea").bind("focus blur keydown change propertychange", function (c) {
                var f = b.classNames[c.type], j = b.classNames.focus, h = b.classNames.keydown, i = b.classNames.blur, k = a(this).closest("." + b.options.fieldWrapperClass), l = b._getGroupField(k);
                switch (c.type) {
                    case "focus":
            ...
            c.length != 6 ? f(!1) : a.get("/ValidateCaptcha.ashx", {key: b, answer: c}, function (a) {
                f(a == "true")
            })
        }, _validateReCaptcha: function (b, c) {
            a.get("/ValidateCaptcha.ashx", {key: Recaptcha.get_challenge(), answer: Recaptcha.get_response(), imageVerificationType: "recaptcha"}, function (a) {
                a == "true" ? b() : c()
            })
        }, _submitForm: function () {
            var b = this, c = a("#ReCaptchaAnswer", b.$element), f = a("#ReCaptchaChallenge", b.$element);
            ...
            var b = this, g = this.options.formSubmittedClass, f = this.options.formDeliveredClass, j = this.options.formErrorClass, h = g + " " + f + " " + j, i = this.$element.find("input[type=submit], button");
            a.ajax({url: this.$element.attr("action"),
                type: "post", data: this.$element.serialize(), beforeSend: function () {
            ...
            var b = a.attr("data-type") ||
                    "always-valid", c = a.find("input, textarea"), j = this.validationTypes[b], h = a.attr("data-required") === "true", i = this._isEmpty(a), j = j instanceof RegExp ? Boolean(c.val().match(j)) : j(a);
            if (h && i)
            ...
            var c = b.attr("data-type"), j = this.options.validClass, h = this.options.invalidClass, i = this.options.requiredClass, k = this,
                    l = function () {
                        k._validate(b)
                    };
            b.removeClass(j + " " + h + " " + i);
            if (a == "required" || a == "invalid")
                return a == "invalid" ? b.addClass(h) : b.addClass(i), "recaptcha" != c && this.errorSensitivity != "low" && (j = this.errorSensitivity == "high" ? "keyup" : "blur", b.data("error-state") || (b.data("error-state", !0), b.find("input, textarea").bind(j, l))), !1;
